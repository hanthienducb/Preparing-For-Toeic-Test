...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new VocabFragment(), "Vocab");
    ...
    private  void setupTabIcons(){
        ...
        tabIntro.setText("Intro");
        tabIntro.setCompoundDrawablesWithIntrinsicBounds(0,R.mipmap.ic_info_white_24dp,0,0);
        ...
        tabVocab.setCompoundDrawablesWithIntrinsicBounds(0, R.mipmap.ic_library_books_white_24dp, 0, 0);
        ...
        tabGrammar.setText("Gram");
        tabGrammar.setCompoundDrawablesWithIntrinsicBounds(0,R.mipmap.ic_tab_white_24dp,0,0);
